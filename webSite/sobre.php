...
<head>
    ...
    <link rel="stylesheet" href="webSite/CSS_WebSite/sobre.css">
    <title>Sobre</title>
</head>
<body>
<header>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/car-card.png" class="d-block w-100" alt="...">
    </div>
  </div>
</div>
    ...
    <div class="container-fluid bg-gradient">
        <div class="row">
            <div class="col-sm-12 text-white py-3">
                <p class="mb-0">Copyright &copy; 2021 - Todos os direitos reservados para <strong>BMW Joinville</strong>.</p>
            </div>
        </div>
    </div>
</footer>
